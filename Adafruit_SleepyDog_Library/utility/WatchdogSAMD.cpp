...
// 11/23 Additions are added due to some bug with WDT never waking up due to a hard fault handler. Read more here: https://community.atmel.com/comment/2625116#comment-2625116

int WatchdogSAMD::sleep(int maxPeriodMS) {

  int actualPeriodMS = enable(maxPeriodMS, true); // true = for sleep

  // Fix as noted on https://github.com/adafruit/Adafruit_SleepyDog/issues/9
  // Added 11/23
